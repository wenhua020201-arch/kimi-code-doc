...
[Claude Code](https://docs.anthropic.com/en/docs/claude-code) 是 Anthropic 推出的命令行编程助手。通过配置环境变量将其接入 Kimi 的 API 端点，你就能在 Claude Code 中直接调用 Kimi 的 AI 能力，在熟悉的终端交互里获得 Kimi Code 的编程体验。
