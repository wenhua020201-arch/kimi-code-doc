...
**2.1.0** — 修复了企业数据查询的已知问题，提升调用稳定性。

**2.0.2** — 新增历史股价、公司基本面与财务报表、企业数据及学术数据查询能力。

**2.0.0** · 2025 年 5 月 1 日 — 首次发布，支持 A 股、港股、美股实时行情查询。
...
> 调用成功后，可在[控制台](https://www.kimi.com/code/console)的**使用记录**中确认本次调用记录。
