...
Kimi CLI 会自动保存你的对话历史，方便你随时继续之前的工作。

## 会话续接

每次启动 Kimi CLI 时，都会创建一个新的会话。如果你想继续之前的对话，有几种方式：
...
当你继续一个已有会话时，Kimi CLI 会回放之前的对话历史，让你快速了解上下文。回放过程中会显示之前的消息和 AI 的回复。

## 清空与压缩

随着对话的进行，上下文会越来越长。Kimi CLI 会在需要的时候自动对上下文进行压缩，确保对话能够继续。
