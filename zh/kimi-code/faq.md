...
::: warning 📢 版本说明
Kimi Code CLI 已完成重大版本升级，底层从 Python/uv 迁移至 Node.js，旧版将不再维护。本页中 CLI 相关章节（安装、鉴权、ACP、更新升级等）部分内容可能反映旧版行为，仅供参考。VS Code 相关内容不受影响。查看 [版本升级](/kimi-code-cli/cli-migration) 了解详情。
