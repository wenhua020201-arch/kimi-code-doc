...
export ANTHROPIC_AUTH_TOKEN=<your API Key>  # Fill in the API Key generated on the membership page
...
$env:ANTHROPIC_AUTH_TOKEN="<your API Key>"  # Fill in the API Key generated on the membership page
