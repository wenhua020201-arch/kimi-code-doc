...
winget install --exact --source winget --id Git.Git # Or install Git via other methods, e.g., https://git-scm.com/install/windows
winget install --exact --source winget --id OpenJS.NodeJS # Or install Node.js via other methods, e.g., https://nodejs.org/en/download
