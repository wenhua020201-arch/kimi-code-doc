...
The new Kimi Code CLI (Node.js) does not currently support ACP integration. If you prefer using ACP in JetBrains IDE, it is only available on the legacy CLI (Python/uv) for now.
:::
