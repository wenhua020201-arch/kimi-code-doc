...
|--------------|------------|---------|
| `The API Key appears to be invalid or may have expired` | 401 | [Authentication Errors](#invalid-api-key) |
| `Invalid Authentication` | 401 | [Authentication Errors](#invalid-authentication) |
| `unable to verify your membership benefits` | 402 | [Membership Benefit Unavailable](#unable-to-verify-membership) |
| `Kimi For Coding is currently only available for Coding Agents` | 403 | [Permission Errors](#client-not-on-whitelist) |
| `You've reached your usage limit for this billing cycle` | 403 | [Permission Errors](#billing-cycle-quota-exhausted) |
| `Access terminated` | 403 | [Permission Errors](#account-access-terminated) |
| `The engine is currently overloaded` | 429 | [Rate Limits & Quotas](#inference-engine-overloaded) |
| `We're receiving too many requests` | 429 | [Rate Limits & Quotas](#too-many-concurrent-requests) |
| `You've reached your usage limit for this period` | 429 | [Rate Limits & Quotas](#5-hour-rolling-quota-reached) |
| `You've reached kimi monthly usage limit` | 429 | [Rate Limits & Quotas](#monthly-kimi-quota-exhausted) |
| `total message size N exceeds limit 2097152` | 400 | [Request Format Errors](#message-body-exceeds-context-limit) |
| `Your request exceeded model token limit: 262144` | 400 | [Request Format Errors](#token-limit-exceeded) |
| `thinking is enabled but reasoning_content is missing` | 400 | [Request Format Errors](#missing-reasoning-content-field) |
| `unsupported image url` | 400 | [Request Format Errors](#unsupported-image-url) |
| `function name ... is duplicated` | 400 | [Request Format Errors](#duplicate-tool-name) |
| `The request was rejected because it was considered high risk` | 400 | [Request Format Errors](#content-safety-rejection) |
| `Not found the model kimi-for-coding or Permission denied` | 404 | [Resource Not Found](#model-not-found) |
| `method not found` | 404 | [Resource Not Found](#endpoint-not-found) |
| `bot_id ... value does not match id_kinds` | 500 | [Internal Server Errors](#invalid-bot_id-format) |
| `failed to connect to ... database=membership_` | 500 | [Internal Server Errors](#database-connection-failed) |
| `FATAL: terminating connection due to administrator command` | 500 | [Internal Server Errors](#database-connection-failed) |
| `failed to evaluate rate limit script` | 500 | [Internal Server Errors](#internal-connection-error) |
| `i/o timeout` / `conn closed` / `bad connection` | 500 | [Internal Server Errors](#internal-connection-error) |
| `503 Service Unavailable` / `504 Gateway Timeout` / `502 Bad Gateway` | 500 | [Internal Server Errors](#downstream-service-unavailable) |
| `context canceled` | 499 | [Tool Call Errors](#request-canceled) |
| `url2text` / `spider checkUrl failed` / `invalid html` | 500 | [Tool Call Errors](#web-page-read-failed) |
| `image_url:moderation request error` | 500 | [Tool Call Errors](#image-moderation-failed) |
| `We consider the current URL poses a security risk` | 403 | [Tool Call Errors](#url-security-risk-blocked) |
| `invalid_url: The provided URL is invalid` | 400 | [Tool Call Errors](#invalid-url-format) |
